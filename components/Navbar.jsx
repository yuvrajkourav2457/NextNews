...
const Navbar = () => {
  return (
    <nav className='flex p-4 items-center gap-10 justify-around border-b border-gray-200 sticky top-0 bg-white z-50'>
       ...
       <section>
        <ul className='hidden md:flex gap-8 max-lg:gap-4 items-center px-10'>
          <Link href={'/home'}><li className='text-md ease-linear duration-200 cursor-pointer hover:scale-105'>Home</li></Link>
